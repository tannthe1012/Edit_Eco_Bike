...
//	public static final String INVOICE_MEDIA_SCREEN_PATH = "/views/fxml/media_invoice.fxml";
	...
	public static final String ADMIN_BIKE_SCREEN_PATH = "/views/fxml/AdminBike.fxml";
	...
	public static final String ADD_NEW_BIKE_PATH = "/views/fxml/add_new_bike.fxml";
	
	public static final String BIKE_INFO_PATH  = "/views/fxml/bike_info.fxml";
	public static final String BIKE_RENTAL_PATH  = "/views/fxml/rental_bike.fxml";
	...
	public static final String BIKE_DETAIL_ADMIN  = "/views/fxml/BikeItem.fxml";
